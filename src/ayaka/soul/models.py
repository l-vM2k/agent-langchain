"""Soul data models — records and enums for the soul core.

Field names and defaults are kept behavior-equivalent so the strategy tables
(weights, deltas, thresholds) apply 1:1.
"""
...
class PersonalityDimensions(BaseModel):
    ...
    Field order is fixed; defaults are the WARM_COMPANION warmth baseline.
    """

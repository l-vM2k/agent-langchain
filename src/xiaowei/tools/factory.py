"""Tool factory — mirrors AgentConfigResolver.buildToolkit.
...
class ToolFactory:
    """按 AgentConfig 组装工具集 — 对应 AgentConfigResolver.buildToolkit。"""
    ...
    async def build_mcp_tools(self, agent_cfg: AgentConfig) -> list[BaseTool]:
        ...
        from xiaowei.tools.mcp import create_mcp_tools
    ...
    def _builtin_tools(self, agent_cfg: AgentConfig) -> list[BaseTool]:
        """内置工具: current_time + calculator — 对应 registerCurrentTimeTool 等。"""
    ...
    def _rest_tools(self, agent_cfg: AgentConfig) -> list[BaseTool]:
        """REST 工具 — 对应 registerRestTool。"""
        from xiaowei.tools.rest import create_rest_tool
